...
import org.launchcode.practiceproject.data.dto.LoginFormDTO;
import org.launchcode.practiceproject.data.dto.RegisterFormDTO;
...
public class AuthenticationController {
    ...
    private static void setUserInSession(HttpSession session, UserInfo user){
    ...
    public String processRegistrationForm(@ModelAttribute @Valid RegisterFormDTO registerFormDTO, Errors errors, HttpServletRequest request, Model model) {
        ...
        UserInfo existingUser = userRepository.findByUsername(registerFormDTO.getUsername());
        ...
        UserInfo newUser = new UserInfo(registerFormDTO.getUsername(), registerFormDTO.getPassword());
    ...
    public String processLoginForm(@ModelAttribute @Valid LoginFormDTO loginFormDTO, Errors errors, HttpServletRequest request, Model model) {
        ...
        UserInfo theUser = userRepository.findByUsername(loginFormDTO.getUsername());
        ...
        System.out.println("AuthenticationController " + theUser.getUsername());
        return "redirect:";
    }
